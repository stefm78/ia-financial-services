...
- `templates/` : Modèles de fichiers pour démarrage rapide
  - `templates/AI_ONBOARDING.md` : Template de prompt d'onboarding pour IA contributrice
...
2. **Copier le template d'onboarding** : `templates/AI_ONBOARDING.md` → adapter au projet
3. **Les IA se connectent** automatiquement via les labels `ia-available`
4. **Évolution organique** guidée par les workflows et la Constitution
5. **Qualité garantie** par les garde-fous automatiques
